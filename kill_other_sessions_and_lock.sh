...
# Detect current graphical session ID
...
# --- Kill other loginctl sessions not sharing PIDs with current graphical session ---
...
# --- Block future logins unless unlock.flag exists ---
